...
def get_task_html(project, start=0, item_status=None):
	return frappe.render_template("kis/templates/includes/projects/project_tasks.html",
		{"doc": {
			"name": project,
...
def get_timesheet_html(project, start=0):
	return frappe.render_template("kis/templates/includes/projects/project_timesheets.html",

...
$.extend(shopping_cart, {
	...
	bind_address_select: function() {
		$(".cart-addresses").on('click', '.address-card', function(e) {
			...
			return frappe.call({
				type: "POST",
				method: "kis.shopping_cart.cart.update_cart_address",
				freeze: true,
				args: {
					address_type,
					address_name
	...
	apply_shipping_rule: function(rule, btn) {
		return frappe.call({
			btn: btn,
			type: "POST",
			method: "kis.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		return frappe.call({
			type: "POST",
			method: "kis.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	request_quotation: function(btn) {
		return frappe.call({
			type: "POST",
			method: "kis.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	apply_coupon_code: function(btn) {
		return frappe.call({
			type: "POST",
			method: "kis.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {
